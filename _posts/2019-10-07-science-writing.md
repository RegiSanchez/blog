...
tesis y artículos científicos. Sin lugar a dudas, la escritura formal es una de
las actividades primordiales de la comunidad académica y científica.
...
escritura de este tipo de textos puede resultar intimidante o muy difícil,
sobretodo si no tenemos conocimiento del proceso de escritura o no tenemos
completamente claro en qué consiste el texto que nos proponemos escribir.
...
Aunado a la falta de claridad de ideas, otra barrera que puede inicialmente
obstaculizar la escritura efectiva de un artículo es la falta de familiaridad
con la estructura y requisitos de este tipo de texto. Como estudiantes de
posgrado, todos hemos leído o revisado publicaciones científicas como parte de
nuestro trabajo de investigación. Así que independientemente de tu experiencia
escribiendo artículos científicos, seguramente has notado ya la estructura de
un artículo. Por lo general, los artículos publicados en revistas científicas
se componen de los siguientes elementos: Título, Autores y Afiliación, Resumen,
Introducción, Métodos, Resultados, Discusión, Conclusiones, Agradecimientos y
Referencias o Literatura Citada. Ciertamente, aunque en la gran mayoría de los
artículos científicos se estructuran siguiendo esta secuencia, el orden de las
...
algunos tips que pueden ser útiles a la hora de escribir cada una de ellos.
 ...
 1. **Título**
    ...
    cuidado para describir razonablemente y de forma breve, en qué consiste el
    artículo. Es recomendable que sea lo más corto posible, siendo aún así
 ...
 2. **Autores**
    ...
    artículo. Cuando hay más de dos autores, los nombres son separados por
 ...
 4. **Introducción**
    ...
    hallazgos más relevantes por parte de otros científicos. En general, la
    ...
    *Antecedentes:* ¿Quién más ha hecho qué y cómo lo ha hecho? Es decir, los
    ...
    of the art”), incluidos – de ser así – aquellos que hayan sido realizados
 ...
 6. **Resultados y discusión**
    ...
    Los resultados no tienen porque ser necesariamente discutidos en orden
 ...
 7. **Conclusiones**
    ...
    discusión, sino interpretando el significado e importancia de los
    resultados obtenidos en el contexto general del campo de estudio al que
    pertenecen. Muestra hasta que grado se alcanzaron los objetivos del
    trabajo, pero evita repetir lo ya expresado en el resto del texto –
    incluidos el resumen y la introducción –. Considera también incluir
 ...
 9. **Referencias (Literatura citada)**
    ...
    (artículos, libros, tesis, etc.) en los que te basaste para establecer el
    contexto de tu trabajo, para justificar algún argumento, para comparar tus
    resultados o aquellos de los que hiciste uso de citas textuales, datos,
    tablas, figuras, etc. El uso  de cualquier tipo de información sin citar su
    fuente es considerado plagio, evita esta mala práctica.


A lo largo del texto hemos hablado de lo importante que es la expresión clara
de las ideas y de cómo un buen artículo es aquél en el que se logra este
objetivo. Si no somos claros expresando lo que queremos decir corremos el
riesgo de perder el interés de los lectores. Y si no hay nadie que se interese
en leer lo que escribimos, ¿cuál es el objetivo de hacerlo? Por lo tanto, te
...
redactar un artículo científico de forma clara:
 ...
 1. **Evita en lo posible el uso de términos técnicos.** Si bien es cierto que
    ...
    sólo porque creemos que la complejidad técnica de un escrito refleja
    nuestra capacidad intelectual, pero vale la pena cuestionarnos si su uso es
...
A pesar de la información y recomendaciones que hemos presentado, la tarea de
escribir un artículo científico puede no dejar de ser difícil. No obstante, el
simple hecho de comenzar a escribir ya es un avance importante, pero ¿qué hacer
si no sabes por dónde comenzar o si te has bloqueado durante el proceso de
escritura? Una estrategia que resulta muy útil es organizar el material con el
que cuentas hasta el momento y crear un *outline*.

Un *outline* es un plan escrito de la organización de un artículo, incluyendo
los datos en los que se basa o se basará la investigación. Básicamente consiste
...
condensar la información y replantearse un proyecto es mucho más eficiente con
la ayuda de un outline, que si se comienza a escribir hasta tener “suficientes”
datos; ningún proyecto está del todo completo aún después de haberse publicado.

Finalmente, no dudes escribir cualquier idea que te venga a la mente, escribe
